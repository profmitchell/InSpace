      ...
      <div className="space-y-4">
        ...
        <div className="mt-4 p-3 bg-gray-700/50 rounded-lg">
          ...
          <ul className="text-white/70 text-xs space-y-1">
            <li>
              <span className="bg-gray-600 px-1.5 py-0.5 rounded mr-1">Shift</span> + Drag: Lock to current axis
            </li>
            <li>
              <span className="bg-gray-600 px-1.5 py-0.5 rounded mr-1">Shift</span> (while dragging): Lock current axis
            </li>
          </ul>
        </div>
      </div>
