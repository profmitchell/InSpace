  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 p-4">
      ...
      <div className="text-center mb-2">
        <h1 className="text-2xl font-bold font-inter text-white">InSpace</h1>
        <a
          href="https://www.cohen-concepts.com"
          target="_blank"
      ...
      <div className="flex flex-row items-start justify-center gap-8">
        ...
        >
          <div className="flex flex-col items-center gap-2 h-full">
            ...
            <div className="relative flex-grow flex items-center justify-center w-full">
              <AnimatePresence mode="wait">
                {settings.showBothModes ? (
                  // Show both modes at once with reduced opacity for inactive mode
                  <motion.div
                    key="both"
                  ...
                  >
                    <div
                      className="absolute inset-0 flex items-center justify-center"
                      style={{ opacity: currentMode === "transform" ? 1 : 0.3 }}
                    >
                      <TransformGizmo
                        svgRef={svgRef}
                        settings={settings}
                    ...
                    <div
                      className="absolute inset-0 flex items-center justify-center"
                      style={{ opacity: currentMode === "rotate" ? 1 : 0.3 }}
                    >
                      <RotateGizmo
                        svgRef={svgRef}
                        settings={settings}
          ...
          {/* Settings Panel - Now positioned to the right */}
          {showSettings && (
